    ...
    <ScrollView className='flex-1 bg-white'>
      <View className='flex-1 bg-white'>
        <View className="relative w-full h-[300px]">
          ...
          <Text className='absolute bottom-5 left-5 text-2xl text black font-JakartaSemiBold'>{t('auth.signIn')} 🚘</Text>
        </View>
        <View className='p-4'>
          <InputField
            label={t('auth.email')}
          ...
          <CustomButton title={t('auth.signIn')} onPress={onSignInPress} className='mt-6' />
