import { cleanTextForSpeech, generateAIResponse } from '@/components/Chat/AIAssistant';
...
import { ActivityIndicator, Image, Keyboard, Platform, Text, View } from 'react-native';
...
export default function ChatInterface({
    ...
    const [volumeToggledMessages, setVolumeToggledMessages] = useState<Set<string>>(new Set());
    ...
    const toggleVolumeMessage = useCallback((messageId: string) => {
    ...
    }, [speakingMessageId, toggledMessages, volumeToggledMessages, speakMessage, toggleVolumeMessage]);
        ...
        if (isTyping) {
            return (
                <View style={{ padding: 10, alignItems: 'center' }}>
                    ...
                    <Text style={{ color: '#666666', fontFamily: 'Jakarta', fontSize: 12, marginTop: 5 }}>
                        Trợ lý MyApp đang phản hồi...
                    </Text>
                </View>
            );
        }
